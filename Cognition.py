...
save_file = 'C:/Users/ybrot/Desktop/WebCam/train_model'
...
with tf.Session() as sess:
    ...
    while (True):
        ...
        cv2.rectangle(img_color, (200, 200), (312,312 ), (0, 0, 255), 3)
        cv2.imshow('bgr', img_color)

        img_roi = img_input[200:312, 200:312]
        ...
        if key == 27: # esc 로 종료
            ...
            with tf.compat.v1.Session():
                print('Number:', (tf.argmax(predictions, 1).eval()))
